...
StaticJsonDocument<400> payload_out;
//********************************
...
char gps_date_time[100]; //Fecha hora de gps
...
void setup() {
  ...
  Serial.begin(115200);
  Serial2.begin(GPSBaud,SERIAL_8N1,RXD2,TXD2); //Comunicacion UART GPS
...
void loop() {
  ...
  if (now - lastMsg > 5000) {
    ...
    digitalWrite(PIN_LED,HIGH);
      ...
      payload_out["gps_date_time"] = gps_date_time;
